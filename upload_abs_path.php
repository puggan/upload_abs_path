...
DEFINE("UPLAOD_ABS_PATH_PLUGIN_VERSION",'0.0.1');

add_filter('upload_dir', 'upload_abs_path_fix');

function upload_abs_path_fix($param)
{
	if(defined( 'UPLOADS' ))
	{
		if(substr(UPLOADS, 0, 1) == '/')
		{
